      ...
      try {
        ...
        api.query.system.events((events) => {
          events.forEach((record) => {
            const { event } = record
            if (event.section == "serviceRequest" || event.section == "rewards" || event.section == "orders" || event.section == "geneticTesting" || event.section == "balances" || event.section == "electronicMedicalRecord" || event.section == "geneticData" || event.section == "geneticAnalysisOrders") {
