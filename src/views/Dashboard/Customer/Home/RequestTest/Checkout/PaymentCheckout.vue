    ...
    async getServiceDetail() {
      ...
      this.service = {
        ...
        totalPrice: this.formatPrice(
          detailPrice.totalPrice.replaceAll(",", "")
        ),
        servicePrice: this.formatPrice(
          detailPrice.priceComponents[0].value.replaceAll(",", "")
        ),
        qcPrice: this.formatPrice(
          detailPrice.additionalPrices[0].value.replaceAll(",", "")
        ),
